...
export default async function main() {
    ...
    try {
        ...
        multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", multiLang.getBaseLocale());
    } catch (error) {
    ...
    if (enButton) {
        enButton.addEventListener('click', async () => {
            try {
                ...
                multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", 'en-US');
            } catch (error) {
    ...
    if (krButton) {
        krButton.addEventListener('click', async () => {
            try {
                ...
                multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", 'ko-KR');
            } catch (error) {
    ...
    if (jaButton) {
        jaButton.addEventListener('click', async () => {
            try {
                ...
                multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", 'ja-JP');
            } catch (error) {
        ...
        autoButton.addEventListener('click', async () => {
            try {
                ...
                try {
                    ...
                    multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", nav);
                } catch (error) {
                    // Navigator language not available, use base locale
                    const base = multiLang.getBaseLocale();
                    await multiLang.switchLocale(base);
                    multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", base);
                }
            } catch (error) {
    ...
    if (select) {
        ...
        select.addEventListener('change', async (e) => {
            try {
                ...
                multiLang.applyTranslations(document, "data-i18n", "data-i18n-html", e.target.value);
            } catch (error) {
